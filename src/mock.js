...
Dans la soirée, nous nous rencontrons avec des amis et nous décidons comment passer notre soir joyeusement. Parfois, nous nous promenons, écoutons de la musique et bavardons. Et parfois nous allons au cinéma, à la discothèque ou au café. Environ à huit heures, je suis à la maison. Je dîne, regarde la télé, parle avec mes amis par téléphone. A dix heures je me couche (je vais au lit). Demain tout commence à nouveau.
  ...
  {
    title: "Le choix d’une profession",
    imgUrl: "images/professions.png",
    id: "3",
    text: `
...
Dans quinze jours j’aurai les examens scolaires. Si j’ai de bonnes notes, mes parents me payeront mes études à n’importe quelle université. Si j’ai de mauvaises notes, alors je n’entrerai pas à l’université. En ce cas, je serai forcé de travailler. Du matin jusqu’au soir, je lis les livres et je répète les matériels didactiques. Parfois je sors pour jouer avec mes amis. Mais la plupart du temps je suis très occupé. En ce moment, le choix de la profession est la plus importante chose de ma vie.
  ...
  {
    title: "Mon loisir",
    imgUrl: "images/hobbies.png",
    id: "4",
    text: `
    Du lundi au vendredi, la plupart des gens ne font que travailler. Mais une personne ne peut pas travailler tout le temps sans cesse. L’homme est une créature sociale. Il a besoin de repos, de communication et d'émotions positives. 

Comme beaucoup d’autres personnes, j’ai l’habitude de travailler beaucoup. Le lundi, je me lève à six heures du matin juste et dans une heure je vais au travail. Mais dès que ma journée de travail finit, le plaisir commence. A trois heures de l'après-midi, je suis libre, donc j’ai le droit de faire ce que je veux. Je ne vais pas à la maison sitôt après le travail. D’habitude je vais au café ou au restaurant, je commande le dîner et je me détends. 
...
Dans l'ensemble, il y a quatre saisons. Tout d’abord, c’est l’été - la plus amusante saison de l’année. L’hiver aussi est un drôle temps de l’année, bien qu’il fasse un peu froid. Le printemps est le symbole de tout ce qui vit. Et, bien sûr, c’est l’automne. 
